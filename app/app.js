...
var Entity = React.createClass({displayName: "Entity",
    ...
    render: function(){
        ...
        var inner =  (showForm == true) ?
            ...
            React.createElement(EnteredValue, {
                value: value}
            ) ;
        return(
          React.createElement("div", null, 
            React.createElement("h2", null, "Wikipedia lookup"), 
            React.createElement("form", {onSubmit: this.handleSubmit}, 
            inner, 
                React.createElement("input", {className: "btn btn-primary typesubmit", type: "submit", value: submitValue})
            )
          )
        );
    }
...
var EnteredValue = React.createClass({displayName: "EnteredValue",
    render: function(){
        var style = {width: '396px', height: '50px', display: 'inline-block'}
        return (
            React.createElement("div", {className: "value-entered", style: style}, this.props.value)
        )
    }
});
...
React.render(
    React.createElement(Entity, null),
    document.getElementById('entity')
);
},{"./improved":1,"react":149}],3:[function(require,module,exports){
